...
public class Daniel {
    ...
    public Daniel(Context context, float screenWidth, float screenHeigth){
    ...
    public Daniel (Context context, float initialX, float initialY, float screenWidth, float screenHeigth){
